...
cat $1/rzmerl* | sed -n '0~2p' | cut -d " " -f 1 > .elapsed

cat $1/rzmerl* | sed -n '0~2p' | cut -d " " -f 2 > .PKG_W_0
cat $1/rzmerl* | sed -n '0~2p' | cut -d " " -f 3 > .PP0_W_0
cat $1/rzmerl* | sed -n '0~2p' | cut -d " " -f 4 > .DRAM_W_0

cat $1/rzmerl* | sed -n '0~2p' | cut -d " " -f 60 > .PKG_W_1
cat $1/rzmerl* | sed -n '0~2p' | cut -d " " -f 61 > .PP0_W_1
cat $1/rzmerl* | sed -n '0~2p' | cut -d " " -f 62 > .DRAM_W_1
...
cat $1/rzmerl* | sed -n '0~2p' | cut -d " " -f 36 > .PKG_C_0
cat $1/rzmerl* | sed -n '0~2p' | cut -d " " -f 35 > .PKG_E_0

cat $1/rzmerl* | sed -n '0~2p' | cut -d " " -f 52 > .DRAM_C_0
cat $1/rzmerl* | sed -n '0~2p' | cut -d " " -f 51 > .DRAM_E_0


cat $1/rzmerl* | sed -n '0~2p' | cut -d " " -f 94 > .PKG_C_1
cat $1/rzmerl* | sed -n '0~2p' | cut -d " " -f 93 > .PKG_E_1

cat $1/rzmerl* | sed -n '0~2p' | cut -d " " -f 110 > .DRAM_C_1
cat $1/rzmerl* | sed -n '0~2p' | cut -d " " -f 109 > .DRAM_E_1
...
cat $1/rzmerl* | sed -n '0~2p' | cut -d " " -f 42 > .PKG_Lim1_W_0
cat $1/rzmerl* | sed -n '0~2p' | cut -d " " -f 100 > .PKG_Lim1_W_1

cat $1/rzmerl* | sed -n '0~2p' | cut -d " " -f 58 > .DRAM_Lim1_W_0
cat $1/rzmerl* | sed -n '0~2p' | cut -d " " -f 116 > .DRAM_Lim1_W_1
